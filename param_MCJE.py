# Minecraft Java Edition 1.21.1 plugin server
...
PLAYER_NAME = "nao2g"  # player name in Minecraft
PLAYER_ORIGIN = Vec3(-35, 00, -35)  # po.x, po.y, po.z
...
Y_CLOUD_BOTTOM = 192  # the bottom of clouds
Y_SEA = 62  # the sea level
Y_BOTTOM = -64  # the bottom where blocks can be set
Y_BOTTOM_STEVE = -128  # the bottom where Steve can go down
